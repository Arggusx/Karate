    ...
    <div className="page-anim">
      <section className="relative bg-jp-paper py-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-8 relative">
          ...
          <button
            onClick={pickRandom}
            className="mt-8 inline-flex items-center gap-3 bg-jp-red text-white px-6 py-3 tracking-widest text-xs uppercase hover:bg-[#9a0024] transition-colors"
          >
              ...
              <div key={c.titulo} className="mb-6 break-inside-avoid">
                <Reveal delay={Math.min(i * 40, 320)}>
                  <div className="card-elev bg-white border border-black/5 p-6 relative overflow-hidden">
                    <div className="absolute -top-4 -right-4 font-jp-serif text-7xl text-jp-red/10 select-none">{i + 1}</div>
                    <div className="font-jp-serif text-jp-red text-xs tracking-widest uppercase">雑学</div>
