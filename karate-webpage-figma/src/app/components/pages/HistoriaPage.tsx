...
import { TIMELINE, MESTRES, PRECEITOS_NIJU_KUN } from "../data";
    ...
    <div className="page-anim">
                    ...
                    <div className={`grid md:grid-cols-2 gap-6 ${right ? "md:[direction:rtl]" : ""}`}>
                      <div className={`pl-12 md:pl-0 ${right ? "md:pl-12 [direction:ltr]" : "md:pr-12 md:text-right"}`}>
                        ...
                        <button
                          ...
                          className={`mt-3 inline-flex items-center gap-2 text-xs tracking-widest uppercase text-jp-red hover:text-jp-ink transition-colors ${right ? "" : "md:flex-row-reverse"}`}
                        >
              ...
              <Reveal key={m.nome} delay={i * 80}>
                <div className="card-elev bg-white border border-black/5 p-6 flex gap-5">
                  ...
                  <div>
                    ...
                    <div className="font-jp-serif text-jp-red text-sm">{m.kanji}</div>
      ...
      <section className="py-24 bg-jp-paper">
        <div className="max-w-5xl mx-auto px-5 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <Reveal>
            <div className="text-jp-red text-xs tracking-widest uppercase">Okinawa-Te · 沖縄手</div>
            ...
            <div className="bg-white border border-black/5 p-6">
              ...
              <ul className="mt-4 space-y-4">
                <li className="flex gap-4">
                  <div className="font-jp-serif text-4xl text-jp-red w-16">首里</div>
                  <div>
                ...
                <li className="flex gap-4">
                  <div className="font-jp-serif text-4xl text-jp-red w-16">那覇</div>
                  <div>
                ...
                <li className="flex gap-4">
                  <div className="font-jp-serif text-4xl text-jp-red w-16">泊</div>
                  <div>
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-8">
          <Reveal>
            <div className="text-center mb-10">
              ...
              <h2 className="font-jp-serif text-3xl mt-2">A origem do nome 松濤館</h2>
      ...
      <section className="py-24 bg-jp-ink text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-8 grid md:grid-cols-2 gap-12 items-center relative">
          ...
          <Reveal delay={150}>
            <div className="relative aspect-square max-w-md mx-auto rounded-full border-[6px] border-jp-red flex items-center justify-center">
              <div className="font-jp-serif text-jp-red text-[12rem] leading-none">虎</div>
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-jp-ink px-4 font-jp-serif tracking-widest text-jp-gold text-xs uppercase">松濤館</div>
            </div>
          </Reveal>
        </div>
      </section>
